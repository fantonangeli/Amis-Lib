...
ConvertA1Class = function() {
    ...
    */
   this.indexToColA1 = function(number)    {
           var numeric = (number - 1) % 26;
           var letter = chr(65 + numeric);
           var number2 = parseInt((number - 1) / 26);
           if (number2 > 0) {
               return ConvertA1.indexToColA1(number2) + letter;
           } else {
               return letter;
           }
       };
